...
class parsing:
    ...
    def __filteration__(self, run_date):

        raw_df = self.obj.get_data("edl_raw_iptv.ip_playback_raw",["device.accountSourceId",
            ...
            filter((col("eventtype")=="End") & (col("application.applicationname") == "STB-XI6") &
                   (col("asset.assetclass") == "Linear")).\
            ...
            filter((col("metrics.mediaOpenLatency").isNotNull()) & (col("metrics.buffercount").isNotNull()) & (col("metrics.bufferratio").isNotNull())).\
